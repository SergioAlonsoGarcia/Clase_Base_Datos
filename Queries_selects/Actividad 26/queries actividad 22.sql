...
DROP VIEW IF EXISTS pelicula_categoria;
...
DROP VIEW IF EXISTS pelicula_idioma; 
...
DROP VIEW IF EXISTS categoria_pelicula;

CREATE VIEW categoria_pelicula AS
...
DROP VIEW IF EXISTS clientes_dinero;

CREATE VIEW clientes_dinero AS
...
DROP VIEW IF EXISTS direccion_tienda;

CREATE VIEW direccion_tienda AS 
...
DROP VIEW IF EXISTS fecha_pelicula;

CREATE VIEW fecha_pelicula AS
...
DROP VIEW IF EXISTS ciudades_clientes;

CREATE VIEW ciudades_clientes AS
...
DROP VIEW IF EXISTS clientes_pelicula;

CREATE VIEW clientes_pelicula AS
...
DROP VIEW IF EXISTS peliculas_rentas;

CREATE VIEW peliculas_rentas AS
...
DROP VIEW IF EXISTS actores_peliculas;
...
DROP VIEW IF EXISTS tiendas_empleados;

CREATE VIEW tiendas_empleados AS
